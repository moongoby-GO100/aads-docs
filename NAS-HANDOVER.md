...
> 배포 대상: NAS repo (서버 114, /root/HANDOVER.md) — 신규 생성

## 시스템 개요
NAS: 이미지·파일 자동화 관리 시스템 (NAS 연동)
서버: 116.120.58.155 (server-114)
WORKDIR: /root
Phase: 유지보수 단계
...
- 작업 디렉토리 이탈 금지: /root 외부 파일 생성 불가
- git-push 의무: 작업 완료 후 commit + push + SHA RESULT_FILE 기록

## CEO-DIRECTIVES 참조
NAS 전용 규칙: aads-docs/NAS-CEO-DIRECTIVES.md
...
- NAS CEO-DIRECTIVES: /root/aads/aads-docs/NAS-CEO-DIRECTIVES.md
