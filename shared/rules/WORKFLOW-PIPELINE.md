...
| 단계 | 이름 | 주체 | 설명 |
|------|------|------|------|
| 1 | CEO 지시 | CEO (moongoby) | Genspark 에이전트 채팅 지시 |
| 2 | 지시서 작성 | Genspark 에이전트 채팅 매니저 | Genspark 에이전트 채팅 매니저가 CEO의 지시를 받아 Bridge 감지 지시서를 작성 |
...
CEO 지시 (Genspark 채팅)
     ↓
Genspark 에이전트 채팅 매니저 Bridge 감지 지시서 작성
     ↓
bridge.py (서버 211)
