# SF (ShortFlow) HANDOVER v1.0
최종 업데이트: 2026-03-07 | 버전: v1.0 — AADS-143 HANDOVER 표준화
> 배포 대상: SF repo (서버 114, /data/shortflow/HANDOVER.md)

## 시스템 개요
ShortFlow(SF): 숏폼 영상 자동 생성 시스템
서버: 116.120.58.155 (서버 114)
WORKDIR: /data/shortflow
...
| 4 | 우선순위 전송 | auto_trigger.sh (서버 114 SSH, 포트 7916) |
...
- 작업 디렉토리 이탈 금지: /data/shortflow 외부 파일 생성 불가
