...
최종 업데이트: 2026-03-09 | 버전: v12.16 — AADS-186E2-BRIDGE PTC allowed_callers 완성 + Deep Research/CodeExplorer 서비스 + 59테스트 통과
...
### a) AADS — Phase 2 운영
- 최근: AADS-186E2-BRIDGE 완료 (PTC allowed_callers 6개 도구+deep_research_service+code_explorer_service+chat_service연동+59테스트 통과) commit: ff97268
- 이전: AADS-186E2 완료 (Deep Research Pydantic 모델+test_deep_research 27개+test_ptc 20개 — 총 88/88 테스트 통과) commit: 69238c8
