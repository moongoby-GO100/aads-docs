...
최종 업데이트: 2026-03-09 | 버전: v12.20 — AADS-188B: 벡터 코드베이스 인덱싱 + 시맨틱 코드 검색 (ChromaDB + Gemini Embedding) 30/30 테스트 통과
...
### a) AADS — Phase 2 운영
- 최근: AADS-188B 완료 (벡터 코드베이스 인덱싱: code_indexer_service+semantic_code_search+context_builder 연동+30테스트) commit: 8ae390d
