...
최종 업데이트: 2026-03-09 | 버전: v12.18 — AADS-188A: Gemini Deep Research API 통합 업그레이드 + 46/46 테스트 통과
...
### a) AADS — Phase 2 운영
- 최근: AADS-188A 완료 (Deep Research: research_stream AsyncGenerator+GOOGLE_GENAI_API_KEY+context/format 파라미터+Langfuse span+46테스트) commit: c36c927
