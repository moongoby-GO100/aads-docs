...
## 시스템 개요
NewTalk V2(NTV2): AI 기반 뉴스 토크 콘텐츠 자동 생성 시스템
서버: 116.120.58.155 (server-114) / rfree-009 (114.207.244.86) 확인 필요
WORKDIR: /srv/newtalk-v2
Phase: Phase 1 — 환경 구축 단계
...
| 4 | 우선순위 전송 | auto_trigger.sh (server-114 SSH, 포트 7916) |
...
NTV2 라우팅 특이사항:
- 기본: server-114 (116.120.58.155, 포트 7916)
- rfree-009 (114.207.244.86) 확인 후 반영 예정
...
| 최근 태스크 | NT-001 |
| 상태 | Phase 1 환경 구축 대기 |
| 서버 | 114 (원격 실행, 포트 7916) |

## 참조
- AADS HANDOVER: /root/aads/aads-docs/HANDOVER.md
- NTV2 CEO-DIRECTIVES: /root/aads/aads-docs/NTV2-CEO-DIRECTIVES.md
